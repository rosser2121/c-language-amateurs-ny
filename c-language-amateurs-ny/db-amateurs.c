...
#define MAX_DATA 512 // equals the maximum data size
#define MAX_ROWS 100 // equals max data size

//struct in C is just like an onject in Javascript
...
//Aborts the program from any error
